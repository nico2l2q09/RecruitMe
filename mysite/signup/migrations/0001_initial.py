    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(default='media/none/no-img.jpg', max_length=100000, upload_to='documents/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('interested', models.ManyToManyField(related_name='user_interested', to=settings.AUTH_USER_MODEL)),
                ('interestee', models.ManyToManyField(related_name='user_interestee', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Player',
